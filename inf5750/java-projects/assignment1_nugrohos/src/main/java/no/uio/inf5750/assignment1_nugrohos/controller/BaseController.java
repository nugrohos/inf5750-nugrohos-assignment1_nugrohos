package no.uio.inf5750.assignment1_nugrohos.controller;
...
import no.uio.inf5750.assignment1_nugrohos.model.MessageDao;
...
public class BaseController {
        ...
        public String welcomeName(@PathVariable String name, ModelMap model) {
        		...
        		model.addAttribute("message", "Maven Web Project + Spring 3 MVC - WelcomeName " + name);
                return "index";
        ...
        public String helloWorld(@PathVariable String name, ModelMap model) {
                ...
                //Spring uses InternalResourceViewResolver and return back hello.jsp
                return "hello";
...
// Hibernate section
        ...
        /*
         * Prints the message with a given id version-2
         */
        @RequestMapping(value="/read_id", method = RequestMethod.GET)
        public String readIdv2(@RequestParam int id, ModelMap model) {
                Message message = messageDao.get(id);
                if (message != null) {
                        model.addAttribute("message", "Message number "+id+" was: "+message.getContent());
                }
